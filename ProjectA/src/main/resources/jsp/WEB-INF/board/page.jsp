...
<div class="card">
	...
	<div class="card-body">
		...
		<ul class="number">
			<li><a href="/board/page/${paging.prePage}/${paging.pageSize}" >&lt;</a></li>
			<c:forEach var="n" items="${paging.navigatepageNums}">
			<c:choose>
			<c:when test="${n eq paging.pageNum}">
				<li><a href="/board/page/${n}/${paging.pageSize}" class="text-danger">${n}</a></li>
			</c:when>
			<c:when test="${n ne paging.pageNum}">
				<li><a href="/board/page/${n}/${paging.pageSize}">${n}</a></li>
			</c:when>
		</c:choose>
	</c:forEach>
			<li><a href="/board/page/${paging.nextPage}/${paging.pageSize}">&gt;</a></li>
		</ul>
